...
from TennisV3.dataset import Shuttlecock_Trajectory_Dataset, data_dir
from TennisV3.utils.general import *
from TennisV3.utils.metric import *
...
def test(model, split, param_dict, save_inpaint_mask=False, linear_interp=False):
    ...
    for rally_dir in rally_dirs:
        ...
        if save_inpaint_mask:
            ...
            csv_file = os.path.join(match_dir, 'predicted_csv',f'{rally_id}.csv')
...
if __name__ == '__main__':
    ...
    if args.video_file:
        ...
        # Load label
        csv_file = os.path.join(match_dir, 'corrected_csv', f'{rally_id}.csv') if 'test' in rally_dir else os.path.join(match_dir, 'csv', f'{rally_id}.csv')
        ...
        out_csv_file = os.path.join(args.save_dir, f'{rally_id}.csv')
