...
from TennisV3.model import TrackNet, InpaintNet
...
def convert_gt_to_coco_json(data_dir, split, drop=False):
    ...
    for rally_dir in rally_dirs:
        ...
        csv_file = os.path.join(match_dir, 'corrected_csv', f'{rally_id}.csv') if split == 'test' else os.path.join(match_dir, 'csv', f'{rally_id}.csv')
